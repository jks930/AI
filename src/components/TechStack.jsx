            ...
            <div className="w-full lg:w-[45%]">
              <div className="sticky top-32">
                ...
                <p className="text-blue-50 text-[16px] leading-[1.8] opacity-90 pr-4">
                  ITMC Digital doesn't merely employ technology; it develops intelligent ecosystems. To create safe and efficient products, we make use of frameworks, generative modeling, and cloud-based resources that are fully scalable. The goal of  ITMC Digital is to assist businesses in converting data-intensive, complex analytical computations into usable information that can help you make the correct business decisions so they can succeed.
                </p>
              </div>
            </div>
              ...
              <div className="flex flex-col">
                {techCategories.map((category) => (
                  <div key={category.num} className="border-b border-blue-400/30">
                    ...
                    {/* Accordion Content */}
                    <div
                      className={`overflow-hidden transition-all duration-300 ease-in-out ${openCategory === category.num ? 'max-h-[500px] pb-8 opacity-100' : 'max-h-0 opacity-0'
                        }`}
                    >
