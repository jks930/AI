...
const leftFaqs = [
  {
    id: 'l1',
    question: "What makes itmcsystem a trusted AI development partner?",
    answer: "itmcsystem stands out as the best AI development company by delivering secure, scalable, and innovative solutions tailored to real business needs. As an experienced artificial intelligence development company, we combine advanced technologies with practical expertise to solve complex challenges."
  },
  {
    id: 'l2',
  ...
  {
    id: 'l4',
    question: "Why choose itmcsystem as your AI partner?",
...
const rightFaqs = [
  ...
  {
    id: 'r4',
    question: "What sets itmcsystem apart from other AI companies?",
    ...
    return (
      <div className="mb-3">
        <button
          ...
          className={`w-full flex items-center justify-between p-5 lg:p-6 text-left rounded-[10px] transition-colors duration-200 ${
            isOpen ? 'bg-[#f8f9fa]' : 'bg-[#f4f7fa] hover:bg-[#edf1f6]'
          }`}
        >
