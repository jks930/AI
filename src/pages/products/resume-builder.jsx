...
import { ArrowRight, CheckCircle2, Zap, Shield, BarChart3, Users, Clock, Globe } from "lucide-react";
...
const ResumeBuilder = () => {
  const features = [
    { title: "AI-Powered Parsing", desc: "Automatically extract and structure data from any document format with 99% accuracy.", icon: <Zap className="w-6 h-6 text-[#F9A826]" /> },
    { title: "ATS Optimization", desc: "Ensure your resumes pass through Applicant Tracking Systems flawlessly with smart formatting.", icon: <Shield className="w-6 h-6 text-[#F9A826]" /> },
    { title: "Dynamic Templates", desc: "Choose from dozens of professionally designed, industry-specific templates.", icon: <BarChart3 className="w-6 h-6 text-[#F9A826]" /> },
    { title: "Real-Time Collaboration", desc: "Work together with career coaches or colleagues using built-in commenting and sharing.", icon: <Users className="w-6 h-6 text-[#F9A826]" /> },
  ];

  return (
    <div className="font-sans text-gray-900 overflow-x-hidden bg-[#fcfcfc]">
      <SEO 
        title="Resume Builder for ATS-Friendly CVs in Minutes Online" 
        description="Create a professional resume with an AI resume builder featuring ATS-friendly templates, smart suggestions, and quick customization for faster job applications." 
        canonical="https://itmcdigital.com/products-and-platforms/resume-builder" 
        schemas={[
          {
          ...
          },
          {
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 3,
                "item": {
                  "@id": "https://itmcdigital.com/products-and-platforms/resume-builder",
                  "name": "Resume Builder"
                }
              }
            ]
          },
          {
            "@context": "https://schema.org",
            "@type": "Service",
            "name": "Resume Builder for ATS-Friendly CVs in Minutes Online",
            "provider": {
              "@id": "https://itmcdigital.com/#organization"
            },
            "description": "Create a professional resume with an AI resume builder featuring ATS-friendly templates, smart suggestions, and quick customization for faster job applications.",
            "url": "https://itmcdigital.com/products-and-platforms/resume-builder",
            "mainEntityOfPage": "https://itmcdigital.com/products-and-platforms/resume-builder",
            "areaServed": "Global"
          }
        ]}
      />
      ...
      <header className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-[#003057]">
        ...
        <div className="relative z-10 px-6 md:px-10 max-w-7xl mx-auto w-full text-center mt-20">
          ...
          <h1 className="text-5xl md:text-7xl font-black text-white leading-tight mb-6 drop-shadow-2xl">
            AI-Powered <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#F9A826] to-[#ffda99]">Resume Builder</span>
          </h1>
          <p className="text-gray-200 text-xl md:text-2xl mt-6 font-light max-w-3xl mx-auto">
            Build professional, high-converting resumes in minutes. Leverage generative AI to craft the perfect narrative for your career progression.
          </p>
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
          <div className="flex-1">
            ...
            <h3 className="text-4xl font-black leading-tight text-[#003057] mb-8">
              Transforming the way you build careers
            </h3>
            <div className="space-y-6">
              {[
                "Reduce resume creation time by up to 80% with AI-driven content suggestions.",
                "Increase interview rates with ATS-optimized keywords and layouts.",
                "Seamlessly export to multiple formats including PDF, Word, and direct web links."
              ].map((point, i) => (
