...
const PulseAI = () => {
  return (
    <div className="font-sans text-gray-900 overflow-x-hidden">
      <SEO 
        title="Pulse AI | AI-Powered Business Process Automation" 
        description="Transform business operations with Pulse AI, an AI-powered platform that automates workflows, improves productivity, and helps teams make faster decisions." 
        canonical="https://itmcdigital.com/products-and-platforms/pulse-ai" 
        schemas={[
          {
          ...
          },
          {
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 3,
                "item": {
                  "@id": "https://itmcdigital.com/products-and-platforms/pulse-ai",
                  "name": "Pulse AI"
                }
              }
            ]
          },
          {
            "@context": "https://schema.org",
            "@type": "Service",
            "name": "Pulse AI | AI-Powered Business Process Automation",
            "provider": {
              "@id": "https://itmcdigital.com/#organization"
            },
            "description": "Transform business operations with Pulse AI, an AI-powered platform that automates workflows, improves productivity, and helps teams make faster decisions.",
            "url": "https://itmcdigital.com/products-and-platforms/pulse-ai",
            "mainEntityOfPage": "https://itmcdigital.com/products-and-platforms/pulse-ai",
            "areaServed": "Global"
          }
        ]}
      />
  ...
  <div className="relative z-10 px-6 md:px-10 max-w-[1200px] mx-auto w-full">
    ...
    <h2 className="text-2xl md:text-3xl text-white mt-3 font-semibold">
      Purpose-Built Intelligence for Global Industries
    </h2>

    <p className="text-white text-lg mt-4 font-light">
      Agentic AI designed around how enterprises actually work
    </p>
        ...
        <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row items-center gap-16">
          <div className="flex-1">
            ...
            <p className="mt-8 text-gray-600 text-lg leading-relaxed">
              ...
              customer trust. With increasing security risks, Chief Officers
              (CXOs) are prioritizing robust cybersecurity measures to protect
              their organizations from evolving threats.
            </p>
          </div>
