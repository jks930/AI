...
const Smartpay= () => {
  return (
    <div className="font-sans text-gray-900 overflow-x-hidden">
      <SEO 
        title="Smart Pay | Secure Digital Payment Solutions" 
        description="Smart Pay delivers secure digital payment solutions with fast processing and flexible integrations. Explore how it can simplify payments for your business today." 
        canonical="https://itmcdigital.com/products-and-platforms/smartpay" 
        schemas={[
          {
          ...
          },
          {
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 3,
                "item": {
                  "@id": "https://itmcdigital.com/products-and-platforms/smartpay",
                  "name": "SmartPay"
                }
              }
            ]
          },
          {
            "@context": "https://schema.org",
            "@type": "Service",
            "name": "Smart Pay | Secure Digital Payment Solutions",
            "provider": {
              "@id": "https://itmcdigital.com/#organization"
            },
            "description": "Smart Pay delivers secure digital payment solutions with fast processing and flexible integrations. Explore how it can simplify payments for your business today.",
            "url": "https://itmcdigital.com/products-and-platforms/smartpay",
            "mainEntityOfPage": "https://itmcdigital.com/products-and-platforms/smartpay",
            "areaServed": "Global"
          }
        ]}
      />
...
Payroll            <br />
            <span className="text-blue-600">That Puts Your Employees First
</span>
          </h2>
      ...
      Driving Progress across Evolving Industries, Powering Everyday Life!

From customer journeys to core operations, we enable businesses to navigate complexity, improve agility, and unlock value at scale—regardless of industry.

Whether it’s enriching customer experiences, digitalizing back-end processes, or managing employee lifecycles, ITMC Digital combines human expertise and AI tools to elevate every touchpoint.
            </p>
          </div>
