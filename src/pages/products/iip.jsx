...
const Iip= () => {
  return (
    <div className="font-sans text-gray-900 overflow-x-hidden">
      <SEO 
        title="Integrated Insurance Platform for Digital Insurance Growth" 
        description="Transform insurance workflows with AI-powered automation, real-time data exchange, underwriting, claims, analytics, and scalable insurance operations." 
        canonical="https://itmcdigital.com/products-and-platforms/integrated-insurance-platform" 
        schemas={[
          {
          ...
          },
          {
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 3,
                "item": {
                  "@id": "https://itmcdigital.com/products-and-platforms/integrated-insurance-platform",
                  "name": "Integrated Insurance Platform"
                }
              }
            ]
          },
          {
            "@context": "https://schema.org",
            "@type": "Service",
            "name": "Integrated Insurance Platform for Digital Insurance Growth",
            "provider": {
              "@id": "https://itmcdigital.com/#organization"
            },
            "description": "Transform insurance workflows with AI-powered automation, real-time data exchange, underwriting, claims, analytics, and scalable insurance operations.",
            "url": "https://itmcdigital.com/products-and-platforms/integrated-insurance-platform",
            "mainEntityOfPage": "https://itmcdigital.com/products-and-platforms/integrated-insurance-platform",
            "areaServed": "Global"
          }
        ]}
      />
...
Integrated Insurance Platform            <br />
            <span className="text-blue-600">with AI-Edge</span>
          </h2>
          <p className="text-white text-2xl mt-6 font-light italic">
            Powering insurance ecosystem with intelligent precision, automation and scalable operations
      ...
      <section className="py-24 px-6 md:px-10 bg-white">
        <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row items-center gap-16">
          <div className="flex-1">
           ...
           Success of InsurTech services demands speed, compliance, and accuracy.
ITMC Digital’s Integrated Insurance Platform (IIP) delivers this through AI-led automation, scalable InsurTech solutions, and 24/7 support services aligned with your business goals. Built from our deep rooted P&C expertise, IIP streamlines Insurance lifecycle by automating end-to-end processes and navigates complex environments with real-time data visibility.
Intelligent data exchange, low-code configurability, and tailored interface integrations for Carriers, MGAs, TPAs, and Brokers, allows our IIP engine to reduces operational friction and enhance service quality for future-ready insurance operations.
            </p>
          </div>
