  ...
  return (
    <div className="font-sans antialiased text-gray-900 bg-[#f9fafb] selection:bg-blue-500/30 selection:text-blue-900 flex flex-col min-h-screen">
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 relative z-10 flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2 flex flex-col text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 border border-blue-100 w-fit mx-auto lg:mx-0 mb-6 backdrop-blur-sm">
              ...
              <span className="text-[#4c00ff] text-sm font-bold tracking-wide uppercase">Core Technology: {tech.title}</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Link to="/#contact" className="bg-[#4c00ff] hover:bg-[#3d00cc] text-white px-8 py-3.5 rounded-full font-bold transition-all shadow-[0_4px_20px_rgba(76,0,255,0.4)] hover:shadow-[0_8px_30px_rgba(76,0,255,0.6)] hover:-translate-y-1 flex items-center justify-center gap-2">
                Consult a Technical Expert <ArrowRight className="w-5 h-5" />
              </Link>
            </div>
          </div>
          ...
          <div className="w-full lg:w-1/2 relative group perspective-1000">
            ...
            <div className="absolute -left-6 top-20 bg-white/90 backdrop-blur-md border border-gray-100 p-4 rounded-xl shadow-2xl hidden md:flex items-center gap-4 z-20 animate-[float-subtle_4s_ease-in-out_infinite]">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#4c00ff] to-cyan-500 flex items-center justify-center">
                <Cpu className="w-5 h-5 text-white" />
              </div>
              <div>
                <p className="text-gray-900 text-sm font-bold">Cutting-Edge Stack</p>
                <p className="text-gray-500 text-xs">Enterprise Ready</p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 lg:py-28 bg-[#f9fafb] relative">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-[32px] lg:text-[44px] font-bold text-[#0a2540] mb-6">Our Capabilities in {tech.title}</h2>
            <p className="text-gray-600 text-lg">
              We don't just use tools; we master them. Discover how our deep technical expertise translates into tangible business advantages for your organization.
            </p>
          </div>
      ...
      <section className="py-20 lg:py-28 bg-white relative border-t border-gray-100">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-[32px] lg:text-[44px] font-bold text-[#0a2540] mb-6">Our Engineering Process</h2>
            <p className="text-gray-600 text-lg">
              A proven, agile methodology to bring your {tech.title} architecture to life rapidly and securely.
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              { step: "01", title: "Architecture", desc: "We design robust, scalable system architectures tailored to your specific goals." },
              { step: "02", title: "Development", desc: "Agile sprints focused on clean code, test-driven development, and rapid iterations." },
              { step: "03", title: "QA & Testing", desc: "Rigorous automated and manual testing to ensure flawless performance and security." },
              { step: "04", title: "Deployment", desc: "Smooth rollout using advanced CI/CD pipelines with zero downtime." }
            ].map((item, idx) => (
      ...
      <section className="py-20 lg:py-28 bg-[#f9fafb] relative border-t border-gray-100">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          <div className="w-full lg:w-1/2">
            <h2 className="text-[32px] lg:text-[44px] font-bold text-[#0a2540] mb-6">Why Trust Us With Your Tech?</h2>
            <p className="text-gray-600 text-lg mb-10">
              With over 10 years of software excellence, we build technology solutions that drive real business growth, not just write code.
            </p>
            <div className="space-y-8">
              {[
                { title: "Senior Engineering Talent", desc: "Our teams consist of elite engineers who have built mission-critical systems for Fortune 500s." },
                { title: "Future-Proof Stacks", desc: "We don't use legacy code. We build using modern frameworks that will scale with you for decades." },
                { title: "Transparent Communication", desc: "Direct access to developers, daily standups, and crystal-clear progress tracking." }
              ].map((item, idx) => (
                <div key={idx} className="flex gap-6">
                  <div className="flex-shrink-0 w-14 h-14 rounded-full bg-blue-100 flex items-center justify-center">
                    <Cpu className="w-7 h-7 text-[#4c00ff]" />
                  </div>
                  <div>
          ...
          <div className="w-full lg:w-1/2">
             <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border border-gray-200">
               <img src="https://images.unsplash.com/photo-1573164713988-8665fc963095?auto=format&fit=crop&w=1000&q=80" alt="Tech Office" className="w-full h-auto object-cover transform hover:scale-105 transition-transform duration-700" />
      ...
      <section className="py-20 relative overflow-hidden bg-white">
        ...
        <div className="max-w-[1000px] mx-auto px-4 text-center relative z-10">
          <h2 className="text-3xl md:text-5xl font-bold text-[#0a2540] mb-8">Ready to Build with {tech.title}?</h2>
